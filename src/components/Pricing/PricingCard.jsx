...
function PricingCard({ Plan, money, title, Button }) {
    return (
        <div className='w-full md:w-[45%] lg:w-[30%] bg-white border-2 border-[#166534] py-16 px-6 rounded-2xl mb-12 shadow-xl'>
            ...
            <button className=' text-xl text-white bg-[#166534] py-2 px-5 capitalize rounded-md hover:bg-black transition-all'>{Button}</button>
            <p className='text-lg mt-7'>{title}</p>
        </div>
    )
}
