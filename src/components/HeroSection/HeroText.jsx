...
function HeroText() {
  return (
    ...
    <h2 className=' text-[#28B463] font-bold text-4xl text-center md:text-left md:text-5xl md:leading-[70px] lg:text-left lg:text-6xl lg:leading-[70px] leading-[50px] lg:mb-7 mb-5 '>
    One-click solution  for your static website.
    </h2>
    <p className='text-black font-normal lg:text-2xl text-xl text-center md:text-left lg:text-left'>
